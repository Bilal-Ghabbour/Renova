        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          ...
          <div className="text-center md:text-left max-w-md">
            <div className="flex gap-4 mb-2">
              ...
              <a
                href="#"
                className="text-3xl hover:text-green-500 transition font-bold mb-4"
              >
                Renova
              </a>
            </div>
            ...
            <p className="mb-4">
              Wir sind ein Online-Shop, der unseren Kunden die Möglichkeit zum
              Kaufen und Verkaufen bietet.
            </p>
            ...
            <div className="flex items-center  justify-center gap-5">
              ...
              <div className="social-button">
                <a
                  ...
                  className="relative w-12 h-12 rounded-full group block"
                >
                  <div className="floater w-full h-full absolute top-0 left-0 bg-blue-900 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                  <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-900 rounded-full">
                    <svg
                      fill="none"
                      viewBox="0 0 13 22"
                      height="22"
